...
export function LogoIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M31 20H17C16.45 20 16 20.45 16 21V27C16 27.55 16.45 28 17 28H31C31.55 28 32 27.55 32 27V21C32 20.45 31.55 20 31 20Z" fill="#6366f1" />
...
export function HeadphonesIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h.008v.008H3.75V12zm0 0c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25m-18 0a9 9 0 018.25 8.25V21c0 .621.504 1.125 1.125 1.125h.75c.621 0 1.125-.504 1.125-1.125v-3H6.75v3c0 .621.504 1.125 1.125 1.125h.75c.621 0 1.125-.504 1.125-1.125v-.75a9 9 0 018.25-8.25" />
    </svg>
  );
}
