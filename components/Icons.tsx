...
export function LogoIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 48 48" fill="none">
      ...
      <path d="M24 10C16.268 10 10 16.268 10 24C10 26.5 10.7 28.8 11.9 30.8L10 38L17.4 36.2C19.3 37.3 21.6 38 24 38C31.732 38 38 31.732 38 24C38 16.268 31.732 10 24 10Z" fill="white" fillOpacity="0.95" />
      <path d="M31 20H17C16.45 20 16 20.45 16 21V27C16 27.55 16.45 28 17 28H31C31.55 28 32 27.55 32 27V21C32 20.45 31.55 20 31 20Z" fill="#0ea5e9" />
...
export function ContactsIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function ReportsIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function DotsVerticalIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function HeadphonesIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 12a9 9 0 1118 0v3a2 2 0 01-2 2h-1a2 2 0 01-2-2v-2a2 2 0 012-2h1a9 9 0 00-14 0h1a2 2 0 012 2v2a2 2 0 01-2 2H5a2 2 0 01-2-2v-3z" />
    </svg>
  );
}
...
export function QRCodeIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function ChartPieIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function UserGroupIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
    </svg>
...
export function AnnotationIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
